...
def twosat(adjlist):
    ...
    for i in range(len(adjlist)):
        if i % 2 == 1: continue
        if father[i] == father[i+1]: return False
    return True
...
#    num_file = '37_80000'
#    f = open('../stanford-algs-master/testCases/course4/assignment4TwoSat/input_beaunus_'+num_file+'.txt')
#    output = open('../stanford-algs-master/testCases/course4/assignment4TwoSat/output_beaunus_'+num_file+'.txt').readlines()
    for i in range(6):
        f = open('../data/2sat' + str(i+1) + '.txt')
